...
def predict(estimator, feature_df, mode="case"):
    ...
    if mode == "case":
        ...
        for idx, result in enumerate(results):
            result['6_months_survival_rate'] = survival_result[idx][0]
            result['12_months_survival_rate'] = survival_result[idx][1]
            result['18_months_survival_rate'] = survival_result[idx][2]
            result['24_months_survival_rate'] = survival_result[idx][3]
